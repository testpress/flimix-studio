...
const CanvasContent: React.FC = () => {
  ...
  return (
    <div
      ref={setNodeRef}
      className="bg-white rounded-lg shadow-lg p-8 min-h-[600px] transition-colors duration-200"
    >
      <div className="mb-6">
      ...
      {/* Drop Zone Indicator - right after debug, before blocks */}
