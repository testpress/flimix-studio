...
const LibraryPanel: React.FC = () => {
  ...
  return (
    <div className={`${isLibraryOpen ? 'w-[22rem] bg-neutral-900 border-r border-neutral-700' : 'w-0 bg-transparent border-0'} sticky top-16 self-start h-[calc(100vh-4rem)] min-h-0 flex flex-col transition-width duration-300 ease-in-out overflow-hidden`}>
      {/* Header */}
      ...
      {/* Block Templates */}
      <div ref={scrollContainerRef} className="flex-1 min-h-0 overflow-y-auto p-4 scrollbar-thin scrollbar-thumb-neutral-700 scrollbar-track-neutral-800">
            ...
            return (
              <div key={template.type} className="relative">
                ...
                <button
                  ...
                  className="w-full aspect-square flex flex-col items-center justify-center p-2 bg-neutral-800 border border-neutral-700 rounded-lg hover:border-indigo-500 hover:shadow-md transition-all duration-200"
                >
                  {/* Icon */}
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-neutral-900 text-white mb-2">
                    <IconComponent 
                      size={18} 
                    />
                  </div>
