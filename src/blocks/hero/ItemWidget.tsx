...
const ItemWidget: React.FC<ItemWidgetProps> = ({
  ...
  return (
    ...
    >
      ...
      {!item.video_background && backgroundImageSrc && (
        <img
      ...
      <div className={`absolute inset-x-0 bottom-0 flex flex-col justify-end ${alignmentClass} z-10 pb-16 pt-32 px-8`}>
        ...
        {/* Category Genres */}
        {item.show_genres !== false && item.genres && item.genres.length > 0 && (
        ...
        {item.show_title !== false && (
          item.title_type === 'image' && item.title_image ? (
            <div className="mb-3">
              <img
        ...
        {/* Metadata Row */}
        {item.show_meta !== false && item.details && Object.values(item.details).some(value => !!value) && (
        ...
        {item.show_hashtag !== false && item.hashtag && item.hashtag.text && (
          <div className="mb-4">
            <span
        ...
        {/* Subtitle */}
        {item.show_subtitle !== false && item.subtitle && (
