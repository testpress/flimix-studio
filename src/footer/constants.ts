...
export interface LayoutPresetConfig {
  id: FooterLayoutPreset;
  label: string;
  cols: number;
  class: string;
  previewClass: string;
}
export const HEADER_ROOT_ID = 'header-root' as const;
export const FOOTER_ROOT_ID = 'footer-root' as const;

export const FOOTER_LAYOUT_PRESETS: LayoutPresetConfig[] = [
  { 
    id: '1-col', 
    label: '1 Column', 
    cols: 1, 
